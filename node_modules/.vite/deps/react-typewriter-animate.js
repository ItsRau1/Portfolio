...
// node_modules/react-typewriter-animate/dist/types.js
var require_types = __commonJS({
  "node_modules/react-typewriter-animate/dist/types.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.TypewriterClassNames = void 0;
    var TypewriterClassNames;
    (function(TypewriterClassNames2) {
      TypewriterClassNames2["Container"] = "Typewriter-container";
      TypewriterClassNames2["Content"] = "Typewriter-content";
      TypewriterClassNames2["Cursor"] = "Typewriter-cursor";
      TypewriterClassNames2["Blink"] = "Typewriter-blink";
      TypewriterClassNames2["Blink_Keyframe"] = "Typewriter-blink-keyframe";
    })(TypewriterClassNames = exports.TypewriterClassNames || (exports.TypewriterClassNames = {}));
  }
});
...
// node_modules/react-typewriter-animate/dist/defaults.js
var require_defaults = __commonJS({
  "node_modules/react-typewriter-animate/dist/defaults.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/react-typewriter-animate/dist/utils/Cursor.js
var require_Cursor = __commonJS({
  "node_modules/react-typewriter-animate/dist/utils/Cursor.js"(exports) {
    "use strict";
    ...
    var blinkCursorHelper = (cursorCurrent, blinkRate, blink) => {
      if (blink) {
...
// node_modules/react-typewriter-animate/dist/utils/WordBlock.js
var require_WordBlock = __commonJS({
  "node_modules/react-typewriter-animate/dist/utils/WordBlock.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.isLastWordBlock = exports.moveToPreviousNonEmptyWordBlock = void 0;
    var moveToPreviousNonEmptyWordBlock = (pack) => {
      const rotateDataIndex = pack.currentDataRotateIndex % pack.copyDataToRotate.length;
      const textBlocks = pack.copyDataToRotate[rotateDataIndex];
      pack.blockPointer--;
...
// node_modules/react-typewriter-animate/dist/utils/String.js
var require_String = __commonJS({
  "node_modules/react-typewriter-animate/dist/utils/String.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.removeChar = exports.insertAt = void 0;
    var insertAt = (des, s, pos) => {
      return [des.slice(0, pos), s, des.slice(pos)].join("");
    };
    exports.insertAt = insertAt;
    var removeChar = (s, pos) => {
...
// node_modules/react-typewriter-animate/dist/helpers/handleWord/deleteChar.js
var require_deleteChar = __commonJS({
  "node_modules/react-typewriter-animate/dist/helpers/handleWord/deleteChar.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.deleteChar = void 0;
    var Cursor_1 = require_Cursor();
    var String_1 = require_String();
    var deleteChar = (props, pack) => {
      (0, Cursor_1.unblinkCursor)(props, pack);
      if (pack.HTMLPointer >= pack.currentHTML.length) {
        pack.HTMLPointer = pack.currentHTML.length - 1;
      }
      trimSpan(pack, 1);
      pack.currentHTML = (0, String_1.removeChar)(pack.currentHTML, pack.HTMLPointer);
      pack.HTMLPointer--;
      pack.internalBlockPointer--;
      trimSpan(pack, 2);
    };
    exports.deleteChar = deleteChar;
    var trimSpan = (pack, id) => {
      if (pack.currentHTML[pack.HTMLPointer] === ">" && pack.currentHTML.substring(pack.HTMLPointer - "</span".length, pack.HTMLPointer + 1) === "</span>") {
        pack.HTMLPointer -= "</span>".length;
      }
      if (pack.currentHTML[pack.HTMLPointer] === ">") {
        let pointer = pack.HTMLPointer - 5;
        let isOpeningSpan = false;
        if (pack.currentHTML.substring(pointer, pointer + 5).indexOf("<") === -1 && pack.currentHTML.substring(pointer, pointer + 5).indexOf(">") === -1) {
          while (pointer >= 0) {
...
// node_modules/react-typewriter-animate/dist/helpers/handleAction/delete.js
var require_delete = __commonJS({
  "node_modules/react-typewriter-animate/dist/helpers/handleAction/delete.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.handleDelete = void 0;
    var defaults_1 = require_defaults();
    var Cursor_1 = require_Cursor();
    var WordBlock_1 = require_WordBlock();
    var deleteChar_1 = require_deleteChar();
    var handleDelete = (props, pack, moveOn, amount) => {
      ...
      if (amount <= 0) {
        ...
        if (pack.blockPointer === textBlocks.length - 1) {
          const waitTime2 = timeBeforeDelete !== null && timeBeforeDelete !== void 0 ? timeBeforeDelete : defaults_1.DefaultSetting.timeBeforeDelete;
...
// node_modules/react-typewriter-animate/dist/helpers/handleAction/function.js
var require_function = __commonJS({
  "node_modules/react-typewriter-animate/dist/helpers/handleAction/function.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.handleFunction = void 0;
    var defaults_1 = require_defaults();
    var handleFunction = (props, pack, moveOn, func) => {
...
// node_modules/react-typewriter-animate/dist/helpers/handleAction/index.js
var require_handleAction = __commonJS({
  "node_modules/react-typewriter-animate/dist/helpers/handleAction/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var handleAction = (props, pack, moveOn) => {
      var _a, _b;
      const rotateDataIndex = pack.currentDataRotateIndex % pack.copyDataToRotate.length;
      const textBlocks = pack.copyDataToRotate[rotateDataIndex];
      const currentBlock = textBlocks[pack.blockPointer];
...
// node_modules/react-typewriter-animate/dist/helpers/handleLifeCycle.js
var require_handleLifeCycle = __commonJS({
  "node_modules/react-typewriter-animate/dist/helpers/handleLifeCycle.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.resetPack = void 0;
    var resetPack = (pack) => {
      pack.internalBlockPointer = 0;
      pack.blockPointer = 0;
      pack.HTMLPointer = 0;
...
// node_modules/react-typewriter-animate/dist/utils/CopyData.js
var require_CopyData = __commonJS({
  "node_modules/react-typewriter-animate/dist/utils/CopyData.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.deepCopyData = void 0;
    var deepCopyData = (data) => {
      return data.map((el) => {
        return el.map((block) => Object.assign({}, block));
      });
    };
...
// node_modules/react-typewriter-animate/dist/helpers/handleWord/addChar.js
var require_addChar = __commonJS({
  "node_modules/react-typewriter-animate/dist/helpers/handleWord/addChar.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.addChar = void 0;
    var Cursor_1 = require_Cursor();
    var String_1 = require_String();
    var addChar = (props, pack) => {
      (0, Cursor_1.unblinkCursor)(props, pack);
      const rotateDataIndex = pack.currentDataRotateIndex % pack.copyDataToRotate.length;
      const textBlocks = pack.copyDataToRotate[rotateDataIndex];
      const currentBlock = textBlocks[pack.blockPointer];
      ...
      pack.currentHTML = (0, String_1.insertAt)(pack.currentHTML, char, pack.HTMLPointer);
      pack.HTMLPointer++;
      pack.internalBlockPointer++;
...
// node_modules/react-typewriter-animate/dist/helpers/handleWord/index.js
var require_handleWord = __commonJS({
  "node_modules/react-typewriter-animate/dist/helpers/handleWord/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.handleWord = void 0;
    var defaults_1 = require_defaults();
    var CopyData_1 = require_CopyData();
    var Cursor_1 = require_Cursor();
    var WordBlock_1 = require_WordBlock();
    var addChar_1 = require_addChar();
    var deleteChar_1 = require_deleteChar();
    var handleWord = (props, pack, moveOn) => {
      ...
      const isLoop = loop === void 0 ? defaults_1.DefaultSetting.loop : loop;
      const { current: contentCurrent } = pack.contentRef;
      if (!contentCurrent) {
        return;
      }
      ...
      if (pack.isDeleting && pack.blockPointer === -1) {
        ...
        const waitTime2 = timeBeforeWriteNewRotateData !== null && timeBeforeWriteNewRotateData !== void 0 ? timeBeforeWriteNewRotateData : defaults_1.DefaultSetting.timeBeforeWriteNewRotateData;
        pack.timeoutTick = window.setTimeout(() => {
          moveOn();
        }, waitTime2);
        return;
...
// node_modules/react-typewriter-animate/dist/Typewriter.js
var require_Typewriter = __commonJS({
  "node_modules/react-typewriter-animate/dist/Typewriter.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var defaults_1 = require_defaults();
    var handleAction_1 = require_handleAction();
    var handleLifeCycle_1 = require_handleLifeCycle();
    var handleWord_1 = require_handleWord();
    var types_1 = require_types();
    var CopyData_1 = require_CopyData();
    var Cursor_1 = require_Cursor();
    var Typewriter = class extends react_1.default.Component {
      constructor() {
        super(...arguments);
      ...
      componentDidMount() {
        ...
        const isStart = start === void 0 ? defaults_1.DefaultSetting.start : start;
        if (isStart) {
...
// node_modules/react-typewriter-animate/dist/index.js
var require_dist = __commonJS({
  "node_modules/react-typewriter-animate/dist/index.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    exports.TypewriterClassNames = void 0;
    var types_1 = require_types();
    Object.defineProperty(exports, "TypewriterClassNames", { enumerable: true, get: function() {
      return types_1.TypewriterClassNames;
    } });
    var Typewriter_1 = __importDefault(require_Typewriter());
    exports.default = Typewriter_1.default;
  }
});

// dep:react-typewriter-animate
var react_typewriter_animate_default = require_dist();
export {
  react_typewriter_animate_default as default
};
/*!
 ...
 */
//# sourceMappingURL=react-typewriter-animate.js.map
