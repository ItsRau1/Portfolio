 ...
 * ```
 */
export declare type UseFormReset<TFieldValues extends FieldValues> = (values?: DefaultValues<TFieldValues> | TFieldValues, keepStateOptions?: KeepStateOptions) => void;
