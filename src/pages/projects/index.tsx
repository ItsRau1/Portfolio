...
import { BoxToLinks, BoxToProjects, Container, SectionToProjects, TextHeader } from "./style";
                ...
                <SectionToProjects>
                    <BoxToProjects>
                        ...
                        <BoxToLinks>
                            ...
                            <a href="https://git-hub-blog-itsrau1.vercel.app/">
                                <Globe size={20}/>
                                Web
                            </a>
                        </BoxToLinks>
                    ...
                    <BoxToProjects>
                        ...
                        <BoxToLinks>
                            <a href="https://github.com/ItsRau1/pokedex">
                                <GithubLogo size={20}/>
                                GitHub
                            </a>
                            <a href="https://itsrau1.github.io/pokedex/">
                                <Globe size={20}/>
                                Web
                            </a>
                        </BoxToLinks>
                    ...
                    <BoxToProjects>
                        ...
                        <BoxToLinks>
                            ...
                            <a href="https://itsrau1.github.io/redux-tasks/">
                                <Globe size={20}/>
                                Web
                            </a>
                        </BoxToLinks>
